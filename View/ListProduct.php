...
<head>
    ...
    <link rel="stylesheet" href="css_file/cssforListProduct.css">
...
<body>
    <div class="container">
        <h1 class="text-center" style="margin-top: 50px;"> Danh sách sản phẩm </h1>
        <?php
            try{
                ...
                if($pages>=1)
                {
                    ...
                    if($current_page > 2)
                    {
                        $echoString .= "<a href='ListProduct.php?s=" . ($start-2*$pagerows)."'><button ><</button></a>";
                    }
                    if($current_page > 1)
                    {
                        $echoString .= "<a href='ListProduct.php?s=" . ($start-$pagerows)."'><button class='currenBtn1'>". ($current_page-1) ."</button></a>";
                    }
